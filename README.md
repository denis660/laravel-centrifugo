...
## Features
- Compatible with latest [Centrifugo 3.1.1](https://github.com/centrifugal/centrifugo/releases/tag/v3.1.1) 🚀
...
- Centrifugo Server 3.1.1 or newer (see [here](https://github.com/centrifugal/centrifugo))
